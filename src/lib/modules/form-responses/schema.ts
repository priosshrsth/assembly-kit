...
export const FormResponseItemResponseSchema: z.ZodType<FormResponse> = FormResponseSchema;
...
export const FormResponsesResponseSchema: z.ZodType<FormResponsesResponse> = z.object({
...
export const FormResponseCreateRequestSchema: z.ZodType<FormResponseCreateRequest> = z.object({
  clientId: z.string(),
  companyId: z.string().optional(),
  formId: z.string(),
});
