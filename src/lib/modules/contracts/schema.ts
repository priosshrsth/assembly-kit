...
export const ContractStatusSchema: z.ZodType<ContractStatus> = z.enum(["pending", "signed"]);

export type ContractFieldInputType = "autoFill" | "client" | "fixed" | "variable";

export const ContractFieldInputTypeSchema: z.ZodType<ContractFieldInputType> = z.enum([
  "fixed",
  "autoFill",
  "client",
  "variable",
...
export const ContractResponseSchema: z.ZodType<Contract> = ContractSchema;
...
export const ContractSendRequestSchema: z.ZodType<ContractSendRequest> = z.object({
  clientId: z.string(),
  companyId: z.string().optional(),
